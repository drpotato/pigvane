class Pigvane.Classes.Achievements
    ...
    grant: (achievementName) ->
        ...
        if !@achievementList[achievementName]['granted']
            ...
            textTitle = @game.add.text(100, 10, 'Achievement Unlocked!', {'font': '16pt Emulogic', 'fill': 'white', 'wordWrap': true, 'wordWrapWidth': 100 })
            textName = @game.add.text(100, 40, achievementData['name'], {'font': '12pt Emulogic', 'fill': 'white', 'wordWrap': true, 'wordWrapWidth': 100 })
